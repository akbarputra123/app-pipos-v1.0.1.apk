...
import '../../produk/widgets/usb_printer.dart'; // ✅ USB PRINTER
                  ...
                  children: [
                    ...
                    if (devices.isNotEmpty)
                      ElevatedButton.icon(
                        ...
                        label: const Text("Cetak Bluetooth", style: TextStyle(color: Colors.white),),
                    ...
                    if (_usbAvailable)
                      ElevatedButton.icon(
                        ...
                        label: const Text("Cetak USB", style: TextStyle(color: Colors.white),),
                        style: ElevatedButton.styleFrom(
                          backgroundColor: AppColors.primary,
                        ),
                      ),
